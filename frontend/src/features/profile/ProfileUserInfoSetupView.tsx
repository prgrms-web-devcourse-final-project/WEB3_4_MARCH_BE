...
export const ProfileUserInfoSetupView = ({
    ...
    return (
        <div className="h-full flex flex-col">
            {/* Content */}
            <div
                className="flex-1 overflow-auto py-4 px-1 overflow-y-scroll [&::-webkit-scrollbar]:hidden scrollbar-width-none">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {images.length < maxImages && (
                                <label
                                    className="w-24 h-24 rounded-lg border-2 border-dashed border-gray-300 flex flex-col items-center justify-center cursor-pointer bg-white hover:bg-gray-50">
