...
public class LikeService {
    ...
    public List<Likes> getLikesGiven(Long senderId) {
        return likeRepository.findBySenderId(senderId);
    }

    public List<Likes> getLikesReceived(Long receiverId) {
    ...
    public List<LikeMemberProfileDto> getLikedProfilesBySender(Long senderId) {
        List<Likes> likes = likeRepository.findBySenderId(senderId);
        return likes.stream()
    ...
    public List<LikeMemberProfileDto> getLikerProfilesByReceiver(Long receiverId) {
        List<Likes> likes = likeRepository.findByReceiverId(receiverId);
        return likes.stream()
