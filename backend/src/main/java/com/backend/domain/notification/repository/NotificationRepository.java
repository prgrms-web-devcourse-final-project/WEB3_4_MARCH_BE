...
public interface NotificationRepository extends JpaRepository<Notifications, Long> {
     ...
     * @return 알림 목록
     */
    List<Notifications> findByReceiverIdOrderByCreatedAtDesc(Long receiverId);
     ...
     */
    List<Notifications> findByReceiverIdAndIsDeletedFalseOrderByCreatedAtDesc(Long receiverId);
     ...
     * @return 읽지 않은 알림 목록
     */
    List<Notifications> findByReceiverIdAndIsReadFalseOrderByCreatedAtDesc(Long receiverId);
